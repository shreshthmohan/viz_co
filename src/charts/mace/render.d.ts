export function renderChart({ data, options: { aspectRatio, marginTop, marginRight, marginBottom, marginLeft, bgColor, oppositeDirectionColor, sameDirectionColor, yAxisTitle, xAxisTitle, xValueFormatter, yValueFormatter, directionStartLabel, directionEndLabel, sizeLegendValues, sizeLegendMoveSizeObjectDownBy, sizeLegendTitle, sizeValueFormatter, xAxisTickValues, xScaleType, xScaleLogBase, defaultState, activeOpacity, inactiveOpacity, circleSizeRange, lineWidthRange, searchInputClassNames, goToInitialStateButtonClassNames, clearAllButtonClassNames, xFieldType, yFieldType, }, dimensions: { xFieldStart, xFieldEnd, yFieldStart, yFieldEnd, sizeField, nameField, }, chartContainerSelector, }: {
    data: any;
    options: {
    ...
    chartContainerSelector?: string | undefined;
}): void;
